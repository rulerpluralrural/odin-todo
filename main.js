...
class Project {
	...
	createTask(name, dueDate, priority) {
		...
		_Todos__WEBPACK_IMPORTED_MODULE_1__["default"].saveToLocalStorage();	
		return newTask;
	}
	...
	getTasksToday() {
		return this.tasks.filter((task) => {
			...
			return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(taskDate));
		});
	}
	...
	getTasksThisWeek() {
		return this.tasks.filter((task) => {
			...
			const taskDate = new Date(task.dueDate);
			return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(taskDate));
		});
	}
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   sidebarEventListener: () => (/* binding */ sidebarEventListener)
/* harmony export */ });
...
const sidebarEventListener = () => {
	...
	sidebarUpperContainer.addEventListener("click", (e) => {
		...
		if (e.target.tagName.toLowerCase() === "button") {
			...
			_UI__WEBPACK_IMPORTED_MODULE_1__["default"].clearElement(taskContainer);
		}

		// @ts-ignore
		if (e.target.textContent === "Tasks") {
			_Todos__WEBPACK_IMPORTED_MODULE_0__["default"].projects.forEach((project) => {
				project.tasks.forEach((task) => {
					_UI__WEBPACK_IMPORTED_MODULE_1__["default"].appendTask(task, project);
				});
			});
			// @ts-ignore
...
class Task {
	...
	editTask(newTask) {
		...
		_Todos__WEBPACK_IMPORTED_MODULE_0__["default"].saveToLocalStorage()
	}
...
function createTaskElement(task, project) {
	...
	tasksElement.innerHTML += `
        ...
        <div class="todo-right-el">
            <p class="task-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(
	...
	tasksElement.addEventListener("click", (e) => {
		...
		if (e.target.classList.contains("fa-pen-to-square")) {
			...
			console.log(_Todos__WEBPACK_IMPORTED_MODULE_2__["default"].projects);
			// @ts-ignore
...
const handleEditTaskForm = (tasksElement, task) => {
    ...
    <label for="edit-task-title">Title</label>
		...
		<input type="date" name="date" class="task-date" id="edit-task-date" min="${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(
			new Date(),
			"MM/dd/yyyy"
	...
	editTaskForm.addEventListener("submit", (e) => {
		...
		if (
			...
			task.editTask({
				...
				// @ts-ignore
				dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(editTaskDate.value), "MM/dd/yyyy"),
				// @ts-ignore
...
/* harmony export */ });
/* harmony import */ var _Task_Element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Task_Element */ "./src/Task_Element.js");
...
class UI {
	static loadPage() {
		...
		(0,_Sidebar__WEBPACK_IMPORTED_MODULE_3__.sidebarEventListener)();
	}
	...
	static displayTasks() {
		...
		const activeProject = _Todos__WEBPACK_IMPORTED_MODULE_2__["default"].getActiveProject(selectedProject);
	...
	static handleTaskForm() {
		...
		<label for="date">Due Date</label>
		<input type="date" name="date" class="task-date" id="task-date" min="${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(
			new Date(),
			"MM/dd/yyyy"
		)}" max="12-31-9999" required>
		...
		tasksForm.addEventListener("submit", (e) => {
			...
			if (
				// @ts-ignore
				!(0,_Task_Element__WEBPACK_IMPORTED_MODULE_0__.isValidDate)(tasksDate.value) &&
				// @ts-ignore
				tasksTitle.value &&
				// @ts-ignore
				tasksDate.value &&
			...
			const activeProjectTask = activeProject.createTask(
				...
				tasksTitle.value,
				// @ts-ignore
				(0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(tasksDate.value), "MM/dd/yyyy"),
				// @ts-ignore
	...
	static appendTask(task, project) {
		...
		taskContainer.appendChild((0,_Task_Element__WEBPACK_IMPORTED_MODULE_0__.createTaskElement)(task, project));
	}
	...
	static handleProjectForm() {
		...
		projectsForm.addEventListener("submit", (e) => {
			...
			_Todos__WEBPACK_IMPORTED_MODULE_2__["default"].projects.push(newProject);
			this.appendProject();
		});
		...
		_Todos__WEBPACK_IMPORTED_MODULE_2__["default"].projects.forEach((project) => {
			...
			projectElement.addEventListener("click", (e) => {
				...
				if (e.target.classList.contains("fa-trash-can")) {
					_Todos__WEBPACK_IMPORTED_MODULE_2__["default"].deleteProject(project.id);
...
if (!localStorage.getItem("todos") || localStorage.getItem("todos") === "[]") {
	_Todos__WEBPACK_IMPORTED_MODULE_1__["default"].projects = [
		new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("General Cleaning", [
			new _Task__WEBPACK_IMPORTED_MODULE_2__["default"]("Cleaning the house", "02/20/2023", "Important"),
			new _Task__WEBPACK_IMPORTED_MODULE_2__["default"]("Cleaning the attic", "08/08/2023", "Not Important"),
		]),
		new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("Creating a Bomb", [
			new _Task__WEBPACK_IMPORTED_MODULE_2__["default"]("Setting of the Bomb", "08/18/2023", "Important"),
		]),
	];
} else {
	const getProjects = JSON.parse(localStorage.getItem("todos"));
	_Todos__WEBPACK_IMPORTED_MODULE_1__["default"].projects = getProjects.map((projectData) => {
		...
		project.tasks = projectData.tasks.map((taskData) => {
			const task = new _Task__WEBPACK_IMPORTED_MODULE_2__["default"](taskData.name, taskData.dueDate, taskData.priority);
