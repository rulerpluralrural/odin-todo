...
/* harmony import */ var _Task_Element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Task_Element */ "./src/Task_Element.js");
        ...
        if (e.target.textContent === 'Tasks') {
            ...
            _Todos__WEBPACK_IMPORTED_MODULE_0__["default"].projects.forEach((project) => {
                project.tasks.forEach((task) => {
                    _UI__WEBPACK_IMPORTED_MODULE_1__["default"].appendTask(task)
                })
            })
...
function createTaskElement(task) {
	...
	tasksElement.innerHTML += `
        ...
        <div class="todo-right-el">
            <p class="task-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(task.dueDate), "MM/dd/yyyy")}</p>
	...
	tasksElement.addEventListener("click", (e) => {
		if (e.target.classList.contains("fa-pen-to-square")) {
			...
			const activeProject = _Todos__WEBPACK_IMPORTED_MODULE_0__["default"].getActiveProject(selectedProject);
			tasksElement.remove();
			activeProject.deleteTask(task.id);
			console.log(_Todos__WEBPACK_IMPORTED_MODULE_0__["default"].projects);
	...
	editTaskForm.addEventListener("submit", (e) => {
		...
		if (editTaskTitle.value == null || editTaskTitle.value == "") {
			...
			tasksElement.innerHTML += `
                ...
                <div class="todo-right-el">
                    <p class="task-date">
                        ${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(editTaskDate.value), "MM/dd/yyyy")}
                                        </p>
...
class Todos {
	static projects = [
		new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("Sample Project 1", [new _Task__WEBPACK_IMPORTED_MODULE_1__["default"]('Sample Task', '02/20/2023', 'Important')]),
...
class UI {
	static loadPage() {
		...
		(0,_Sidebar__WEBPACK_IMPORTED_MODULE_4__.sidebarEventListener)();
	}
	...
	static displayTasks() {
		...
		const containerHeader = document.getElementById("content-header");
		const selectedProject = document.querySelector(".active-project");
		const activeProject = _Todos__WEBPACK_IMPORTED_MODULE_3__["default"].getActiveProject(selectedProject)
