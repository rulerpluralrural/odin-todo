...
class Project {
	...
	getTasksThisWeek() {
		return this.tasks.filter((task) => {
			...
			const taskDate = new Date(task.dueDate);
			return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDate))
		});
	}
}
...
const sidebarEventListener = () => {
	...
	sidebarUpperContainer.addEventListener("click", (e) => {
		...
		if (e.target.tagName.toLowerCase() === "button") {
			...
			_UI__WEBPACK_IMPORTED_MODULE_2__["default"].clearElement(taskContainer);
		}

		// @ts-ignore
		if (e.target.textContent === "Tasks") {
			_Todos__WEBPACK_IMPORTED_MODULE_1__["default"].projects.forEach((project) => {
				project.tasks.forEach((task) => {
					_UI__WEBPACK_IMPORTED_MODULE_2__["default"].appendTask(task, project);
				});
			});
			// @ts-ignore
...
function createTaskElement(task, project) {
	...
	tasksElement.innerHTML += `
        ...
        <div class="todo-right-el">
            <p class="task-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate), "MM/dd/yyyy")}</p>
...
// @ts-ignore
                ...
                <div class="todo-right-el">
                    <p class="task-date">
                        ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(editTaskDate.
// @ts-ignore
                        value), "MM/dd/yyyy")}
                                        </p>
			...
			// @ts-ignore
			task.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(editTaskDate.value), "MM/dd/yyyy");
			// @ts-ignore
...
class Todos {
	static projects = [
		new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("General Cleaning", [new _Task__WEBPACK_IMPORTED_MODULE_1__["default"] ('Cleaning the house', '02/20/2023', 'Important'), new _Task__WEBPACK_IMPORTED_MODULE_1__["default"] ('Cleaning the attic', '08/08/2023', 'Not Important')]),
		new _Project__WEBPACK_IMPORTED_MODULE_0__["default"]("Creating a Bomb", [new _Task__WEBPACK_IMPORTED_MODULE_1__["default"]('Bombastic', '08/18/2023', 'Important')])
	];
